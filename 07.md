...
* the key value can be used to trigger input `value`, `defaultValue` renders;
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=andrei.tosa%40moduscreate.com).
